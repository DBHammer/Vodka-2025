...
-- SELECT create_reference_table('vodka_region') USING heap;
-- SELECT create_reference_table('vodka_nation') USING heap;
-- SELECT create_reference_table('vodka_supplier') USING heap;
-- SELECT create_distributed_table('vodka_warehouse', 'w_id') USING heap;
-- SELECT create_distributed_table('vodka_district', 'd_w_id', colocate_with := 'vodka_warehouse') USING heap;
-- SELECT create_distributed_table('vodka_customer', 'c_w_id', colocate_with := 'vodka_warehouse') USING heap;
-- SELECT create_distributed_table('vodka_oorder'       , 'o_w_id', colocate_with := 'vodka_warehouse') USING heap;
-- SELECT create_distributed_table('vodka_order_line'   , 'ol_w_id', colocate_with := 'vodka_warehouse') USING heap;
-- SELECT create_distributed_table('vodka_stock'        , 's_w_id', colocate_with := 'vodka_warehouse') USING heap;