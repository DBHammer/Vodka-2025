...
public class StmtNewOrder extends StmtBasic {
        ...
        public PreparedStatement stmtNewOrderUpdateOrder;
        ...
        public StmtNewOrder(Connection dbConn, int dbType) throws SQLException {
                ...
                stmtNewOrderInsertOrder = dbConn.prepareStatement(
                                "INSERT INTO vodka_oorder (" +
                                                ...
                                                "    o_ol_cnt, o_all_local, o_shippriority, o_comment) " +
                                                "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)");
                ...
                stmtNewOrderInsertOrderLine = dbConn.prepareStatement(
                                "INSERT INTO vodka_order_line (" +
                                                ...
                                                "    ol_amount, ol_dist_info, ol_discount, ol_commitdate, ol_suppkey, access_version, current_ts) "
                                                +
                                                "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
                stmtNewOrderUpdateOrder = dbConn.prepareStatement(
                                "UPDATE vodka_oorder " +
                                                "   SET ol_amount_sum = ? " +
                                                " WHERE o_id   = ? " +
                                                "   AND o_d_id = ? " +
